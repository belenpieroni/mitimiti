  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {/* Encabezado Unificado con el Front Solicitado */}
        <View style={styles.headerRow}>
          <TouchableOpacity style={styles.backBtn} onPress={() => navigation.goBack()}>
            <Ionicons name="chevron-back" size={22} color={colors.textSecondary} />
          </TouchableOpacity>
          <View>
            <Text style={styles.headerTitle}>Alias y CBU</Text>
            <Text style={styles.headerSubtitle}>{nombreUsuario}</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  toastContainer: {
    ...
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 5, gap: 8,
  },
  toastText: { color: 'white', fontWeight: 'bold', fontSize: 14, flex: 1 },
  
  // Estilos del Encabezado heredados del nuevo Front
  headerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 26 },
  backBtn: {
    width: 42, height: 42, borderRadius: 21,
    backgroundColor: '#F2F4F6', justifyContent: 'center', alignItems: 'center', marginRight: 14,
  },
  headerTitle: { fontSize: 18, fontWeight: '700', color: colors.textPrimary },
  headerSubtitle: { fontSize: 13, color: colors.textSecondary, fontWeight: '500', marginTop: 1 },
  ...
  label: { fontSize: 12, fontWeight: 'bold', color: colors.textSecondary, letterSpacing: 0.8, marginBottom: 10, marginLeft: 4 },
  input: {
    backgroundColor: colors.background, borderWidth: 1, borderColor: '#eee',
    borderRadius: 14, padding: 16, fontSize: 16, color: colors.textPrimary, marginBottom: 12,
  },
  infoContainer: { flexDirection: 'row', alignItems: 'flex-start', gap: 6, marginBottom: 24, marginLeft: 4, paddingRight: 10 },
  ...
  btnGuardar: {
    ...
    shadowColor: colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4, marginBottom: 12,
  },
  btnGuardarTexto: { color: 'white', fontSize: 16, fontWeight: 'bold' },
  btnEliminar: { backgroundColor: colors.background, borderRadius: 16, padding: 18, alignItems: 'center', borderWidth: 1, borderColor: '#eee' },
